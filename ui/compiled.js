...
$root.movie = (function() {
    ...
    movie.Detail = (function() {
        ...
        Detail.encode = function encode(message, writer) {
            ...
            if (message.spokenLanguage != null && message.spokenLanguage.length)
                for (var i = 0; i < message.spokenLanguage.length; ++i)
            ...
            if (message.posters != null && message.posters.length)
                for (var i = 0; i < message.posters.length; ++i)
            ...
            if (message.recommendations != null && message.recommendations.length) {
                ...
                for (var i = 0; i < message.recommendations.length; ++i)
            ...
            if (message.similar != null && message.similar.length) {
                ...
                for (var i = 0; i < message.similar.length; ++i)
                    writer.int32(message.similar[i]);
                writer.ldelim();
            }
            if (message.watch != null && message.watch.length)
                for (var i = 0; i < message.watch.length; ++i)
        ...
        Detail.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.movie.Detail();
        ...
        Detail.verify = function verify(message) {
            ...
            if (message.genres != null && message.hasOwnProperty("genres")) {
                ...
                for (var i = 0; i < message.genres.length; ++i) {
                    var error = $root.movie.Genre.verify(message.genres[i]);
                    if (error)
                        return "genres." + error;
                }
            }
            ...
            if (message.votes != null && message.hasOwnProperty("votes")) {
                var error = $root.movie.Votes.verify(message.votes);
                if (error)
                    return "votes." + error;
            }
            ...
            if (message.videos != null && message.hasOwnProperty("videos")) {
                ...
                for (var i = 0; i < message.videos.length; ++i) {
                    var error = $root.movie.Video.verify(message.videos[i]);
                    if (error)
                        return "videos." + error;
                }
            }
            if (message.posters != null && message.hasOwnProperty("posters")) {
                ...
                for (var i = 0; i < message.posters.length; ++i) {
                    var error = $root.movie.Image.verify(message.posters[i]);
                    if (error)
            ...
            if (message.watch != null && message.hasOwnProperty("watch")) {
                ...
                for (var i = 0; i < message.watch.length; ++i) {
                    var error = $root.movie.Watch.verify(message.watch[i]);
                    if (error)
                        return "watch." + error;
                }
            }
        ...
        Detail.fromObject = function fromObject(object) {
            if (object instanceof $root.movie.Detail)
                return object;
            var message = new $root.movie.Detail();
            if (object.id != null)
            ...
            if (object.spokenLanguage) {
                ...
                message.spokenLanguage = [];
                for (var i = 0; i < object.spokenLanguage.length; ++i)
            ...
            if (object.posters) {
                ...
                message.posters = [];
                for (var i = 0; i < object.posters.length; ++i) {
            ...
            if (object.similar) {
                ...
                message.similar = [];
                for (var i = 0; i < object.similar.length; ++i)
            ...
            if (object.watch) {
                ...
                message.watch = [];
                for (var i = 0; i < object.watch.length; ++i) {
        ...
        Detail.toObject = function toObject(message, options) {
            ...
            if (message.spokenLanguage && message.spokenLanguage.length) {
                object.spokenLanguage = [];
                for (var j = 0; j < message.spokenLanguage.length; ++j)
            ...
            if (message.posters && message.posters.length) {
                object.posters = [];
                for (var j = 0; j < message.posters.length; ++j)
                    object.posters[j] = $root.movie.Image.toObject(message.posters[j], options);
            }
            if (message.recommendations && message.recommendations.length) {
                object.recommendations = [];
                for (var j = 0; j < message.recommendations.length; ++j)
                    object.recommendations[j] = message.recommendations[j];
            }
            if (message.similar && message.similar.length) {
                object.similar = [];
                for (var j = 0; j < message.similar.length; ++j)
                    object.similar[j] = message.similar[j];
            }
            if (message.watch && message.watch.length) {
                object.watch = [];
                for (var j = 0; j < message.watch.length; ++j)
    ...
    movie.Genre = (function() {
        ...
        Genre.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.movie.Genre();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Genre.fromObject = function fromObject(object) {
            if (object instanceof $root.movie.Genre)
                return object;
            var message = new $root.movie.Genre();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.name != null)
    ...
    movie.Votes = (function() {
        ...
        Votes.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.movie.Votes();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Votes.fromObject = function fromObject(object) {
            if (object instanceof $root.movie.Votes)
                return object;
            var message = new $root.movie.Votes();
    ...
    movie.Video = (function() {
        ...
        Video.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.movie.Video();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Video.fromObject = function fromObject(object) {
            if (object instanceof $root.movie.Video)
                return object;
            var message = new $root.movie.Video();
            if (object.id != null)
    ...
    movie.Image = (function() {
        ...
        Image.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.movie.Image();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Image.fromObject = function fromObject(object) {
            if (object instanceof $root.movie.Image)
                return object;
            var message = new $root.movie.Image();
    ...
    movie.Watch = (function() {
        ...
        Watch.encode = function encode(message, writer) {
            ...
            if (message.rent != null && message.rent.length)
                for (var i = 0; i < message.rent.length; ++i)
        ...
        Watch.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.movie.Watch();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Watch.verify = function verify(message) {
            ...
            if (message.rent != null && message.hasOwnProperty("rent")) {
                ...
                for (var i = 0; i < message.rent.length; ++i) {
                    var error = $root.movie.Watch.Provider.verify(message.rent[i]);
                    if (error)
                        return "rent." + error;
                }
            }
            if (message.buy != null && message.hasOwnProperty("buy")) {
                ...
                for (var i = 0; i < message.buy.length; ++i) {
                    var error = $root.movie.Watch.Provider.verify(message.buy[i]);
                    if (error)
                        return "buy." + error;
                }
            }
        ...
        Watch.fromObject = function fromObject(object) {
            if (object instanceof $root.movie.Watch)
                return object;
            var message = new $root.movie.Watch();
            if (object.language != null)
                message.language = String(object.language);
            if (object.link != null)
            ...
            if (object.rent) {
                ...
                message.rent = [];
                for (var i = 0; i < object.rent.length; ++i) {
        ...
        Watch.toObject = function toObject(message, options) {
            ...
            if (message.rent && message.rent.length) {
                object.rent = [];
                for (var j = 0; j < message.rent.length; ++j)
        ...
        Watch.Provider = (function() {
            ...
            Provider.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.movie.Watch.Provider();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Provider.fromObject = function fromObject(object) {
                if (object instanceof $root.movie.Watch.Provider)
                    return object;
                var message = new $root.movie.Watch.Provider();
                if (object.id != null)
                    message.id = object.id | 0;
...
$root.queue = (function() {
    ...
    queue.AllItems = (function() {
        ...
        AllItems.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.queue.AllItems();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        AllItems.verify = function verify(message) {
            ...
            if (message.items != null && message.hasOwnProperty("items")) {
                ...
                for (var i = 0; i < message.items.length; ++i) {
                    var error = $root.queue.Item.verify(message.items[i]);
                    if (error)
                        return "items." + error;
                }
            }
        ...
        AllItems.fromObject = function fromObject(object) {
            if (object instanceof $root.queue.AllItems)
                return object;
            var message = new $root.queue.AllItems();
            if (object.items) {
    ...
    queue.Item = (function() {
        ...
        Item.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.queue.Item();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Item.verify = function verify(message) {
            ...
            if (message.movie != null && message.hasOwnProperty("movie")) {
                var error = $root.movie.Detail.verify(message.movie);
                if (error)
                    return "movie." + error;
            }
            return null;
        ...
        Item.fromObject = function fromObject(object) {
            if (object instanceof $root.queue.Item)
                return object;
            var message = new $root.queue.Item();
            if (object.id != null)
                message.id = String(object.id);
...
$root.user = (function() {
    ...
    user.Detail = (function() {
        ...
        Detail.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.user.Detail();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Detail.fromObject = function fromObject(object) {
            if (object instanceof $root.user.Detail)
                return object;
            var message = new $root.user.Detail();
            if (object.id != null)
                message.id = String(object.id);
    ...
    user.Register = (function() {
        ...
        Register.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.user.Register();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Register.fromObject = function fromObject(object) {
            if (object instanceof $root.user.Register)
                return object;
            var message = new $root.user.Register();
            if (object.email != null)
                message.email = String(object.email);
    ...
    user.Update = (function() {
        ...
        Update.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.user.Update();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Update.fromObject = function fromObject(object) {
            if (object instanceof $root.user.Update)
                return object;
            var message = new $root.user.Update();
            if (object.email != null)
                message.email = String(object.email);
            if (object.password != null)
                message.password = String(object.password);
    ...
    user.DetailAndToken = (function() {
        ...
        DetailAndToken.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.user.DetailAndToken();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        DetailAndToken.verify = function verify(message) {
            ...
            if (message.detail != null && message.hasOwnProperty("detail")) {
                var error = $root.user.Detail.verify(message.detail);
                if (error)
                    return "detail." + error;
            }
            return null;
        ...
        DetailAndToken.fromObject = function fromObject(object) {
            if (object instanceof $root.user.DetailAndToken)
                return object;
            var message = new $root.user.DetailAndToken();
