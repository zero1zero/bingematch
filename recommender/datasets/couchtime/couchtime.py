...
# TODO(couchtime): Markdown description  that will appear on the catalog page.
_DESCRIPTION = """
...
# TODO(couchtime): BibTeX citation
_CITATION = """
"""


class Couchtime(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for couchtime dataset."""
...
def parse_current_ratings_data() -> Iterator[Tuple[int, Dict[str, Any]]]:
    ...
    ratings_file_path = 'datasets/couchtime/data/tester.csv'
